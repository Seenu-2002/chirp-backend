package com.seenu.dev.chirp.domain.events.user
...
sealed class UserEvent(
    ...
    data class Created constructor(
        val userId: UserId,
        val email: String,
        val username: String,
    ...
    data class Verified constructor(
        val userId: UserId,
        val email: String,
        val username: String,
    ...
    data class RequestResendVerification constructor(
        val userId: UserId,
        val email: String,
        val username: String,
        val verificationToken: String,
    ...
    data class RequestResetPassword constructor(
        val userId: UserId,
        val email: String,
        val username: String,
        val verificationToken: String,
